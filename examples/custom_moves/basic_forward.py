...
class BasicForward:
    ...
    def _basic_up_motors(self):
        self.up(self.DIST_TAKEOFF, self.VELOCITY_UP)
        print("start up!")
        # runs for TIME_UP seconds
        time.sleep(self.TIME_UP)
        print("end up!")

    def _basic_forward_motors(self):
        self.forward(self.DIST_FORWARD, self.VELOCITY_FORWARD)
        print("start forward!")
        # runs for TIME_UP seconds
